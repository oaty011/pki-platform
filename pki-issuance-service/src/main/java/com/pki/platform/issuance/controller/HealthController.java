...
import com.pki.platform.issuance.service.SystemBootstrapInfoService;
...
public class HealthController {
    ...
    public ApiResponse<Map<String, String>> health() {
        return ApiResponse.success(Map.of("service", "pki-issuance-service", "status", "UP"));
    }
