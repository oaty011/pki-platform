package com.pki.platform.appdomain.controller;

import com.pki.platform.common.response.ApiResponse;
import com.pki.platform.appdomain.service.SystemBootstrapInfoService;
...
public class HealthController {
    ...
    public ApiResponse<Map<String, String>> health() {
        return ApiResponse.success(Map.of("service", "pki-app-domain-service", "status", "UP"));
    }
    ...
    public ApiResponse<Map<String, Object>> dbHealth() {
        ...
        return ApiResponse.success(Map.of(
            "service", "pki-app-domain-service",
            "status", "UP",
