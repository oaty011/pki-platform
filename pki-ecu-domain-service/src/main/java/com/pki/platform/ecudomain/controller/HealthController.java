package com.pki.platform.ecudomain.controller;

import com.pki.platform.common.response.ApiResponse;
import com.pki.platform.ecudomain.service.SystemBootstrapInfoService;
...
public class HealthController {
    ...
    public ApiResponse<Map<String, String>> health() {
        return ApiResponse.success(Map.of("service", "pki-ecu-domain-service", "status", "UP"));
    }
    ...
    public ApiResponse<Map<String, Object>> dbHealth() {
        ...
        return ApiResponse.success(Map.of(
            "service", "pki-ecu-domain-service",
            "status", "UP",
